        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-end relative z-10">
          <div className="lg:col-span-8">
            ...
            <h1 className="font-sans text-5xl md:text-7xl lg:text-8xl font-bold leading-[1] tracking-tight max-w-4xl mb-6">
              ...
              <span className="text-azul-noche italic font-serif font-normal">
                Móviles.
              </span>
            </h1>
            <p className="font-sans text-xl md:text-2xl text-azul-noche/80 leading-relaxed max-w-2xl">
              Un programa de acción territorial que instaló la gestión
              comunitaria de reciclables y la separación en origen en la agenda
              pública en un municipio de la Provincia de Buenos Aires.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-4">
              ...
              <p className="font-sans text-sm font-bold uppercase tracking-[0.2em] text-terracota">
                Resultados
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-azul-noche p-8 rounded-2xl flex flex-col justify-between shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-default">
              <span className="font-sans text-xs font-bold uppercase tracking-widest text-amarillo mb-8">
                Recuperación
              </span>
              <div>
                <div className="font-sans text-6xl font-extrabold text-crema tracking-tighter mb-2">
                  +23
                </div>
                <p className="font-sans text-crema/80 text-sm leading-snug">
                  Toneladas de materiales entregados a la cooperativa Cartón y
                  Justicia.
                </p>
              </div>
            </div>
            ...
            <div className="bg-crema border border-azul-noche/10 p-8 rounded-2xl flex flex-col justify-between shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-default">
              <span className="font-sans text-xs font-bold uppercase tracking-widest text-terracota mb-8">
                Territorio
              </span>
              <div>
                <div className="font-sans text-6xl font-extrabold text-azul-noche tracking-tighter mb-2">
                  +200
                </div>
                <p className="font-sans text-azul-noche/70 text-sm leading-snug">
                  Jornadas de recolección comunitaria sostenidas en el tiempo.
                </p>
              </div>
            </div>
            ...
            {/* Tarjeta 3 */}
            <div className="bg-crema border border-azul-noche/10 p-8 rounded-2xl flex flex-col justify-between shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-default">
              <span className="font-sans text-xs font-bold uppercase tracking-widest text-verde-monte mb-8">
                Comunidad
              </span>
              <div>
                <div className="font-sans text-6xl font-extrabold text-azul-noche tracking-tighter mb-2">
                ...
                <p className="font-sans text-azul-noche/70 text-sm leading-snug">
                  Vecinos involucrados activamente separando en origen.
                </p>
              </div>
            </div>
            ...
            <div className="bg-terracota p-8 rounded-2xl flex flex-col justify-between shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-default">
              <span className="font-sans text-xs font-bold uppercase tracking-widest text-crema/70 mb-8">
                Red de acción
              </span>
              <div>
                <div className="font-sans text-6xl font-extrabold text-crema tracking-tighter mb-2">
                ...
                <p className="font-sans text-crema/90 text-sm leading-snug">
                  Voluntarios comprometidos y 4 convenios firmados con organizaciones de la
                  sociedad civil.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <div className="mb-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <p className="font-sans text-sm font-bold uppercase tracking-[0.2em] text-verde-monte">
                Impacto real
              </p>
            </div>
            <h2 className="font-sans text-4xl md:text-5xl font-bold text-azul-noche">
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-serif italic text-5xl md:text-6xl text-crema leading-[1.1] mb-6">
              ¡Misión{" "}
              <span className="font-sans font-bold not-italic text-azul-noche block mt-2">
                cumplida!
              </span>
            </h2>
          ...
          <div className="lg:col-span-7 lg:pl-12 border-l border-crema/20">
            <p className="font-sans text-xl md:text-2xl text-crema font-medium leading-relaxed mb-6">
              El objetivo de sensibilización e incidencia pública ha sido
              alcanzado.
            </p>
            <p className="font-sans text-lg text-crema/80 leading-relaxed mb-6">
              Visibilizamos la problemática de los residuos sólidos urbanos e
              instalamos la separación en origen en la agenda pública. Hoy, el
              municipio de Lanús cuenta con un programa propio de puntos verdes
              fijos y móviles.
            </p>
            <p className="font-sans text-lg text-crema/80 leading-relaxed italic border-t border-crema/10 pt-6">
              Esta experiencia demuestra que la participación ciudadana, cuando se organiza,
              es motor de cambio para la sostenibilidad de las ciudades.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="max-w-2xl">
            <h2 className="font-sans text-4xl md:text-6xl font-bold text-crema leading-tight mb-6">
              ...
              <span className="font-serif italic font-normal text-amarillo">
                Empieza otra vez.
              </span>
            </h2>
            <p className="font-sans text-lg text-crema/90">
              Iniciamos un nuevo desafío central: la mitigación del cambio
              climático a través del arbolado público urbano.
            </p>
          </div>
          <Link
            to="/guardianes"
            className="bg-amarillo text-azul-noche font-sans font-bold py-5 px-10 rounded-full hover:bg-crema transition-all shadow-2xl hover:-translate-y-1"
          >
